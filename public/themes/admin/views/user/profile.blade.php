            ...
            <div class="col-md-3">
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center">{!!user()->designation!!} - Member Since {!!user()->joined!!}
                        </p>
                        <a href="{{guard_url('profile')}}" class="btn btn-primary btn-block"
                            id="update-profile"><b>Update Profile</b></a>
                        <a href="{{guard_url('password')}}" class="btn btn-warning btn-block"
                            id="change-password"><b>Change Password</b></a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="profile">
                                ...
                                <button type="submit" class="btn btn-primary" id="btn-update-profile">Save
                                    changes</button>

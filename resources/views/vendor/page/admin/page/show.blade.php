<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs primary">
        ...
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-primary btn-sm" data-action='UPDATE' data-form='#page-page-edit'
                data-load-to='#page-page-entry' data-datatable='#page-page-list'><i class="fa fa-floppy-o"></i>
                儲存</button>
            ...
            <button type="button" class="btn btn-danger btn-sm" data-action="UPDATE" data-form='#page-page-edit'
                data-load-to='#page-page-entry' data-datatable='#page-page-list'
                data-href='{{ guard_url('page/page') }}/{{$page->getRouteKey()}}'>
